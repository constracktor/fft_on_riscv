...
# structure
export ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")" >/dev/null 2>&1 && pwd )/fftw_omp_mpi_riscv"
...
mkdir -p $DIR_SRC
cd $DIR_SRC
export DOWNLOAD_URL="https://github.com/rdolbeau/fftw3/releases/download/r5v-test-release-005/fftw-3.3.10+r5v.tar.gz"
